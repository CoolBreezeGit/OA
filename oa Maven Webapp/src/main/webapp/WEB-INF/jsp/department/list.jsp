			...
			<tbody id="TableData" class="dataContainer">
				<s:iterator value="#departmentList">
					<tr>
						...
						<td>${description}&nbsp;</td>
						<td><s:a action="departmentAction_delete?id=%{id}&parentId=%{parentId}"
								onclick="return confirm('确定要删除吗？')">删除</s:a> <s:a
								action="departmentAction_editUI?id=%{id}">修改</s:a> <a
		...
		<div id="TableTail">
			<div id="TableTail_inside">
				...
				<s:if test="parentId != null">
					<s:a	
						action="departmentAction_list?parentId=%{#departmentList[0].parent.parent.id}">
						<img
