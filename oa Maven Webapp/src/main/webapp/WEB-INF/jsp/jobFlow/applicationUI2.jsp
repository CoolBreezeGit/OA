...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="jobFlowAction_application" method="post" enctype="multipart/form-data">
    	<s:hidden name="processTemplateId"></s:hidden>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="processTemplateAction_download?id=%{processTemplateId}">[点击下载文档模板文件]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
