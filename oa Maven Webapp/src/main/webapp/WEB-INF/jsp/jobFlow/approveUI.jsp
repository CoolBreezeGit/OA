...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="jobFlowAction_approve">    	
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="processTemplateAction_download?id=%{processTemplateId}">[点击下载申请的文档]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input onclick="document.form[0].approval='false'" type="image" src="${pageContext.request.contextPath}/style/blue/images/button/disagree.png"/>
