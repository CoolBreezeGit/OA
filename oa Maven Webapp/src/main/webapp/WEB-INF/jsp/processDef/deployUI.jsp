...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="processDefAction_deploy" enctype="multipart/form-data" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						...
						<!-- TODO 需要校验zip格式，且不能为空 -->
                        <td><input type="file" name="upload" class="InputStyle required" style="width:450px;" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
