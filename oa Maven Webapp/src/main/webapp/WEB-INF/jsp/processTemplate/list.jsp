...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="documentTemplateList">
        	<s:iterator value="#processTemplateList">
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<s:a action="processTemplateAction_addUI?id=%{id}"><img src="${pageContext.request.contextPath}/style/blue/images/button/addNew.PNG" /></s:a>
        </div>
    </div>
