			...
			<tbody id="TableData" class="dataContainer">
				...
				<s:iterator value="#userList">
					<tr class="TableDetail1 template">
						...
						<!-- 会引发懒加载异常！！！！需要设置department和roles的lazy属性为false才行！！！ -->
						...
						<td>${description}&nbsp;</td>
						<td>
							<s:a action="userAction_delete?id=%{id}"
								onclick="return delConfirm()">删除
							</s:a> 
							<s:a
								action="userAction_editUI?id=%{id}">修改
							</s:a> 
							<s:a
								action="userAction_initPassword?id=%{id}"
								onclick="return window.confirm('您确定要初始化密码为1234吗？')">初始化密码
							</s:a>
						</td>
					</tr>
				</s:iterator>
