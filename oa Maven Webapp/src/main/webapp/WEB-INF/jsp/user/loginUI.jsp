...
<s:form METHOD="post" NAME="actForm" action="userAction_login">
    <DIV ID="CenterAreaBg">
        <DIV ID="CenterArea">
            ...
            <DIV ID="LoginInfo">
                <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    <TR>
                        <TD  CLASS="Subject"><IMG BORDER="0" SRC="${pageContext.request.contextPath}/style/blue/images/login/userId.gif" /></TD>
            ...
            <DIV ID="CopyRight"><A HREF="javascript:void(0)">&copy; 2016 版权所有 coolbreeze</A></DIV>
        </DIV>
    </DIV>
</s:form>
</BODY>
